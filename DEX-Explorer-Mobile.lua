	...
	The main explorer interface
		...
		local Decompile do
			local Success, Decompile_Source = pcall(function()
				return game:HttpGet("https://raw.githubusercontent.com/NTDCONCUBETI/Duongcutobeti/refs/heads/main/init.lua", true)
			end)
...
Main = (function()
	...
	Main.FetchRMD = function()
		...
		if Main.Elevated then
			...
			rawXML = rawXML or game:HttpGet("https://raw.githubusercontent.com/NTDCONCUBETI/Duongcutobeti/refs/heads/main/ReflectionMetadata.xml")
		else
