...
local OrionLib = {
   ...
   Themes = {
      Default = {
         ...
         Stroke = Color3.fromRGB(232, 181, 138),
...
writefile(OrionLib.Folder .. "/" .. Name .. ".json", tostring(HttpService:JSONEncode(Data)))
end
...
BackgroundTransparency = 1,
MidImage = "rbxassetid://15297431935",
BottomImage = "rbxassetid://15297431935",
TopImage = "rbxassetid://15297431935",
...
NotificationConfig.Image = NotificationConfig.Image or "rbxassetid://15297431935"
...
MakeElement("Stroke", Color3.fromRGB(232, 181, 138), 1.2),
...
pcall(function()
if isfile(OrionLib.Folder .. "Lua" .. game.GameId .. ".json") then
LoadCfg(readfile(OrionLib.Folder .. "Lua" .. game.GameId .. ".json"))
OrionLib:MakeNotification({
Name = "Lua",
Content = "Loadings Config" .. game.GameId .. ".",
Image = "rbxassetid://15297431935",
Time = 5
})
end
end)
...
WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://15297431935"
WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://15297431935"
