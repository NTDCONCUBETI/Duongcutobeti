...
function library:Window(name) 
    ...
    UiWindow.BackgroundColor3 = _G.Color
    UiWindow.BorderColor3 = _G.Color
    ...
    Header.BackgroundColor3 = _G.Color
    Header.BorderColor3 = _G.Color
    ...
    function functions:Toggle(text, on, callback)
        ...
        ToggleButton.Font = _G.Text
        ToggleButton.Text = ""
        ToggleButton.TextColor3 = Color3.fromRGB(0, 0, 0)
        ToggleButton.TextSize = _G.Size
        ...
        ToggleFiller.BackgroundColor3 = _G.Color
    ...
    function functions:Dropdown(text, buttons, callback)
        ...
        function dropFunctions:Button(name)
            ...
            Button_2.Font = _G.Text
            Button_2.TextColor3 = Color3.fromRGB(245, 246, 250)
            Button_2.TextSize = _G.Size
    ...
    function functions:ColorPicker(name, default, callback)
        ...
        ColorPicker.Font = _G.Text
        ColorPicker.Text = ""
        ColorPicker.TextColor3 = Color3.fromRGB(0, 0, 0)
        ColorPicker.TextSize = _G.Size
        ...
        ToggleRGB.Font = _G.Text
        ToggleRGB.Text = ""
        ToggleRGB.TextColor3 = Color3.fromRGB(0, 0, 0)
        ToggleRGB.TextSize = _G.Size
        ...
        ClosePicker.Font = _G.Text
        ClosePicker.Text = "X"
        ClosePicker.TextColor3 = Color3.fromRGB(245, 246, 250)
        ClosePicker.TextSize = 16.000
